...
<html lang="fr">
	...
	<head>
		...
		<title>Théâtre Sénart - Connexion professionnel</title>
	</head>
	...
	<body>
		...
		<center><h3>Espace professionel</h3></center><<br/><br/>
		<div class="form">
			<center><form class="connexion" action="comptePro.php" method="POST" >
